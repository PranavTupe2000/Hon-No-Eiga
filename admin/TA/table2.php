...
if(isset($_POST["submit"])){
    ...
    $query ="CALL findShowsWithMovie('$t_id','$screen_no','$show_date')";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="table2.php"><i class="fas fa-table"></i><span>Shows</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <form class="user" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleFirstName" placeholder="Screen Number" name="screen_no"></div>
