                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Create an Show!</h4>
                            </div>
                            <form class="user" method="POST" enctype="multipart/form-data" >
                                ...
                                <button class="btn btn-primary btn-block text-white btn-user" type="submit" name="submit">Create Show</button>
                                <hr>
                            </form>
                        </div>
                    </div>
...
if(count($errors) == 0){
    ...
    $queryI ="CALL newshow('$movie_id','$t_id','$screen_no','$show_lang','$show_dimension','$show_date','$show_time',$show_cost,'false');";
    $ok=mysqli_query($db,$queryI);
    $_SESSION['CRUD'] = "SUCCESFULLY CREATED NEW SHOW!";
}
