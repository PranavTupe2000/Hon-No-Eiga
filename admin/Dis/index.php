...
<?php
if(!isset($_SESSION["month_earn"])){
    $query0 ="CALL monthE('$dis_id');";
    $result0= mysqli_query($db,$query0);
    $data0 = mysqli_fetch_all($result0,MYSQLI_ASSOC) ;
    $_SESSION['month_earn'] = $data0[0]['earning'];
  }
  
  $monthEarn =$_SESSION['month_earn'];
  
  if(!isset($_SESSION["year_earn"])){
    $query0 ="CALL yearE('$dis_id');";
    $result0= mysqli_query($db,$query0);
    $data0 = mysqli_fetch_all($result0,MYSQLI_ASSOC) ;
    $_SESSION['year_earn'] = $data0[0]['earning'];
  }
  
  $yearEarn=$_SESSION['year_earn'];
?>
<!DOCTYPE html>
<html>
...
<body id="page-top">
            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0"><?php echo $dis_name."'s";?> Dashboard</h3>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $monthEarn ;?></span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $yearEarn;?></span></div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4" onclick="createM()">
                                <div class="card text-white bg-primary shadow">
                                    <div class="card-body">
                                        ...
                                        <p class="text-white-50 small m-0">Add a new movie</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-4" onclick="readM()">
                                <div class="card text-white bg-success shadow">
                                    <div class="card-body">
                                        <p class="m-0">Read</p>
                                        <p class="text-white-50 small m-0">Search movie</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-4" onclick="updateM()">
                                <div class="card text-white bg-info shadow">
                                    <div class="card-body">
                                        ...
                                        <p class="text-white-50 small m-0">Change movie info</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-4" onclick="deleteM()">
                                <div class="card text-white bg-warning shadow">
                                    <div class="card-body">
                                        ...
                                        <p class="text-white-50 small m-0">Delet a movie</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        function createM(){
            window.location.href ="createm.php";
        }
        function readM(){
            window.location.href ="readm.php";
        }
        function updateM(){
            window.location.href ="updatem.php";
        }
        function deleteM(){
            window.location.href ="deletem.php";
        }
    </script>
</body>
