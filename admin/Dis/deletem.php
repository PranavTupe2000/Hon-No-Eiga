                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Delete a Movie</h4>
                            </div>
                            <form class="user" method="POST"  >
                                ...
                                <button class="btn btn-primary btn-block text-white btn-user" type="submit" name="submit">Delete Movie</button>
                                <hr>
                            </form>
                        </div>
                    </div>
...
if(count($errors) == 0){
    ...
    $queryI ="CALL deletemovie('$movie_id')";
    $ok=mysqli_query($db,$queryI);
    $_SESSION['CRUD'] = "SUCCESFULLY DELETED MOVIE!";
}
