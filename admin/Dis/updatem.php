                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" enctype="multipart/form-data" >
                                <div class="form-group"><input class="form-control form-control-user" type="text" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Old Movie ID" name="o_id"></div>    
                                <hr>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleFirstName" placeholder="New Movie ID" name="movie_id"></div>
                                ...
                                <button class="btn btn-primary btn-block text-white btn-user" type="submit" name="submit">Update Movie</button>
                                <hr>
                            </form>
                        </div>
                    </div>
...
if(count($errors) == 0){
    ...
    $queryI ="CALL updatemovie('$o_id','$movie_id','$dis_id','$movie_name','$movie_genre','$movie_duration','$movie_dimension','$movie_trailer','$movie_image');";
    $ok=mysqli_query($db,$queryI);
    $_SESSION['CRUD'] = "SUCCESFULLY UPDATED MOVIE!";
}
